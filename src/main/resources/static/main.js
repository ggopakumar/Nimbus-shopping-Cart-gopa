...
var EcommerceService = /** @class */ (function () {
    function EcommerceService(http) {
        this.http = http;
        this.productsUrl = "http://192.168.99.100:8081/api/products/";
        this.ordersUrl = "http://192.168.99.100:8082/api/cart";
...
module.exports = __webpack_require__(/*! C:\Users\ggopa\Desktop\my Java\etailer-ui\src\main\frontend\src\main.ts */"./src/main.ts");
